...
import com.chuks.maizestemapp.databinding.FragmentFallDetailedBinding
...
* */
class FallWormDetailedFragment : Fragment() {

    private lateinit var binding: FragmentFallDetailedBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(
            inflater,
            com.chuks.maizestemapp.R.layout.fragment_fall_detailed, container, false
        )

        binding.back.setOnClickListener { findNavController().popBackStack() }

        // detailView implementation
        getPlantByNameDetailed("FAW", "fall")
        return binding.root
    }

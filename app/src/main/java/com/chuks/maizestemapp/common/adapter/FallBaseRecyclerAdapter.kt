...
class FallBaseRecyclerAdapter(
    val context: Context,
    val fallFragment: FallArmywormFragment
) :
    RecyclerView.Adapter<FallBaseRecyclerAdapter.BaseViewHolder>() {
...
//        items.removeAt(position)
        fallFragment.deleteFallInsect(position)

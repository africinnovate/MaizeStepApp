...
class SwipeToDeleteCallback(adapter: BaseRecyclerAdapter) :
        ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT or ItemTouchHelper.RIGHT) {
        private val mAdapter: BaseRecyclerAdapter = adapter
    ...
    override fun onMove(
        ...
        override fun onSwiped(viewHolder: RecyclerView.ViewHolder, direction: Int) {
            ...
            val classPredictionId =  mAdapter.items[position].classPredictionId
            val bundle = Bundle()
            bundle.putString("predictionID", classPredictionId)
